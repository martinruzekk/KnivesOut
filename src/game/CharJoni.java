...
/**
 * The type for Character Joni.
 *
 * @author Martin Růžek
 * @version 1.0
 */
public class CharJoni extends Character{
    private GameWorld world;

    /**
     * Instantiates a new Char joni.
     *
     * @param name        the name
     ...
     */
    public CharJoni(String name, Boolean isMurderer, Area currentArea, Map<Area, String> chats, String greeting, GameWorld world) {
