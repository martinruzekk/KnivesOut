...
/**
 * The type for Character Walter.
 *
 * @author Martin Růžek
 * @version 1.0
 */
public class CharWalter extends Character{
    private GameWorld world;

    /**
     * Instantiates a new Char walter.
     *
     * @param name        the name
     ...
     */
    public CharWalter(String name, Boolean isMurderer, Area currentArea, Map<Area, String> chats, String greeting, GameWorld world) {
