...
/**
 * The type for Character Meg.
 *
 * @author Martin Růžek
 * @version 1.0
 */
public class CharMeg extends Character{
    private GameWorld world;

    /**
     * Instantiates a new Char meg.
     *
     * @param name        the name
     ...
     */
    public CharMeg(String name, Boolean isMurderer, Area currentArea, Map<Area, String> chats, String greeting, GameWorld world) {
