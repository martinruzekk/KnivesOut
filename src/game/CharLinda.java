...
/**
 * The type for Character Linda.
 *
 * @author Martin Růžek
 * @version 1.0
 */
public class CharLinda extends Character{
    private GameWorld world;

    /**
     * Instantiates a new Char linda.
     *
     * @param name        the name
     ...
     */
    public CharLinda(String name, Boolean isMurderer, Area currentArea, Map<Area, String> chats, String greeting, GameWorld world) {
